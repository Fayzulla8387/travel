        ...
        <div class="container">
            ...
            <div class="tab-content">
                <div id="tab-1" class="tab-pane fade show p-0 active">
                    <div class="row g-4">
                        @foreach($houses->slice(0, 6) as $house)
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="property-item rounded overflow-hidden">
                                <div class="position-relative overflow-hidden">
                                    <a href=""><img class="img-fluid" src="{{ $house->image ? asset('storage/' . $house->image) : asset('/assets/img/default-house.jpg') }}" alt=""></a>
                                ...
                                <div class="d-flex border-top">
                                    ...
                                    <small class="flex-fill text-center border-end py-2"><i class="fa fa-bed text-primary me-2"></i>{{$house->bedrooms}}</small>
                                    <small class="flex-fill text-center py-2"><i class="fa fa-bath text-primary me-2"></i>{{$house->bathrooms}}</small>
                                </div>
                            </div>
                        </div>
                        @endforeach
            ...
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
                ...
                <div class="testimonial-item bg-light rounded p-3">
                    <div class="bg-white border rounded p-4">
                        <p>{{ \Illuminate\Support\Str::limit($feedback->message, 200) }}</p>
                        <div class="d-flex align-items-center">
                            <img class="img-fluid flex-shrink-0 rounded" src="{{asset('/assets/img/testimonial-1.jpg')}}" style="width: 45px; height: 45px;">
                            <div class="ps-3">
                                <h6 class="fw-bold mb-1">{{$feedback->client_name}}</h6>
                                <small>{{$feedback->subject}}</small>
                            </div>
                        </div>
                    </div>
                </div>
